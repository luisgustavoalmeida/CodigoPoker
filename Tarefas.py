...
def meta_tarefas(x_origem, y_origem):
    ...
    meta_dia= int(metas[dia_semana])
    #print("meta do dia", meta_dia)
    #compara a pontuação atual com o objetivo do dia para saber se foi batido ou nao
    print("meta do dia:", meta_dia, ",pontos atigidos:", pontos)
    if pontos >= meta_dia:
        print("Meta atingida")
        return True, pontos
    else:
...
# itens_comuns = comparar_listas(x_origem, y_origem)
# print(itens_comuns)
# # # # # #
