...
def limpa_pequeno(x_origem, y_origem):
    ...
    # testa se o torneino semanal esta no loob
        ...
        if aviso_sistema:
          ...
          or pyautogui.pixelMatchesColor(715, 650, (32, 33, 36), tolerance=5)  # fundo cinza com o dinoçauro
          ...
          or pyautogui.pixelMatchesColor((x_origem + 700), 650, (221, 221, 221), tolerance=5)): # tela cinza clara com cara ctiste
