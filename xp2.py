...
def pega_2xp(x_origem, y_origem):
    ...
    while tem_2xp:
        ...
        if pyautogui.pixelMatchesColor((x_origem + 241), (y_origem + 146), (250, 112, 1), tolerance=10):  # testa se esta meus objetos
            ...
            if pyautogui.pixelMatchesColor((x_origem + 230), (y_origem + 222), (152, 48, 220), tolerance=10):  # testa se tem a guia de 2xp
                ...
                if (pyautogui.pixelMatchesColor((x_origem + 690), (y_origem + 270), (120, 202, 12), tolerance=10)
                        or pyautogui.pixelMatchesColor((x_origem + 690), (y_origem + 270), (154, 217, 15), tolerance=10)):  # testa se tem o cartão de 2XP sem usar
                    print("Tem 2xp")
                    pyautogui.doubleClick(x_origem + 260, y_origem + 25)  # clica no no icone dos meus objetos
