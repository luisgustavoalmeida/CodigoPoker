...
orderem_chave = {
    ...
    'group2': ['PC05', 'PC08', 'PC11', 'PC14', 'PC17', 'PC20', 'PC23', 'PC26', 'PC29'],
    'group3': ['PC06', 'PC09', 'PC12', 'PC15', 'PC18', 'PC21', 'PC24', 'PC27', 'PC30']
}

# Define listas de arranjos de computadores cada arranjo será uma mesa diferente
arranjo1_pc = (
    'Comandos1/PC04', 'Comandos1/PC07', 'Comandos1/PC10', 'Comandos1/PC13', 'Comandos1/PC16', 'Comandos1/PC19', 'Comandos1/PC22',
